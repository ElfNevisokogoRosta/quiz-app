...
const QuizQuestion: FC<QuizQuestionProps> = ({ question_id, index, question, func, errors, deleteQuestion }) => {
  const [typeQ, setTypeQ] = useState<QuestionSet>('chose_one');
  const [questionData, setQuestionData] = useState<QuestionType>({
    question_id,
    question: '',
    type: QUESTION_TYPE[0],
    answers: question.answers.map(() => ({ answer: '', isCorrect: false })),
  });
